        ...
        code=Container(
            sections=[
                ...
                Section.Code(
                    ...
                    max_stack_increase=outputs + 2 - inputs,
                ),
                Section.Code(
                    Op.POP * inputs
                    ...
                    code_inputs=inputs,
                    code_outputs=outputs + 1,
                    max_stack_increase=outputs + 1 - inputs,
                ),
            ],
        ),
        storage={
