        ...
        code=Container(
            sections=[
                Section.Code(
                    ...
                    + Op.SSTORE(slot_create_address, Op.EOFCREATE[0](0, 0, calldata_size, 0))
                    + Op.STOP,
                ),
                Section.Container(container=initcode_subcontainer),
            ]
        ...
        code=Container(
            sections=[
                Section.Code(
                    ...
                    + Op.SSTORE(slot_create_address_3, Op.EOFCREATE[0](1, 0, 0, 0))
                    + Op.SSTORE(slot_code_worked, value_code_worked)
                    + Op.STOP,
                ),
                Section.Container(container=smallest_initcode_subcontainer),
    ...
    contract_address = pre.deploy_contract(
        code=Container(
            sections=[
                Section.Code(
                    code=Op.CALLDATACOPY(0, 0, Op.CALLDATASIZE)
                    + Op.SSTORE(slot_create_address, Op.EOFCREATE[0](salt, 0, Op.CALLDATASIZE, 0))
                    + Op.SSTORE(slot_returndata_size, Op.RETURNDATASIZE)
                    + Op.STOP,
                ),
...
def test_eofcreate_context(
    ...
    factory_contract = Container(
        sections=[
            Section.Code(
                Op.SSTORE(slot_code_worked, value_code_worked)
                + Op.EOFCREATE[0](0, 0, 0, eofcreate_value)
                + Op.STOP
            ),
